...
def to_small_caps(text):
    ...
    return text.translate(small_caps_translation)

class TEXTS:
    ABOUT_SONG = to_small_caps(
        "**💬 Title:** __{0}__ \n\n"
        "**📺 Channel:** __{1}__ \n"
        "**🕰 Published:** __{2}__ \n"
        "**🔖 Views:** __{3}__ \n"
    ...
    BOOTED = to_small_caps(
        "#START\n\n"
        "**{0} is alive!**\n\n"
        "__» Pbx-Music Version:__ `{1}`\n"
        "__» Python Version:__ `{2}`\n"
        "__» Pyrogram Version:__ `{3}`\n"
        "__» PyTgCalls Version:__ `{4}`\n\n"
        "**</>** {5}"
    )
    PING_REPLY = to_small_caps(
        "**📌 Pinged Bot Server!**\n\n"
        "**🏁 Speed:** __{0} ms__\n"
        "**⏳ Uptime:** __{1}__\n"
        "**🎶 VC Ping:** __{2} ms__"
    )
    PLAYING = to_small_caps(
        "**❆** {0}\n\n"
        "**♪ Song Name:** __{1}__\n"
        "**♪ Duration:** __{2}__\n"
        "**♪ Auxed By:** {3}"
    )
    PROFILE = to_small_caps(
        "**{0}\nUser Profile**\n\n"
        "**💬 Name:** {1}\n"
        "**💠 ID:** `{2}`\n"
        "**📝 User Type:** __{3}__\n"
    ...
    START_GC = to_small_caps(
        "Yeah, I'm alive! "
        "__Wanna listen to some music?__"
    )
    START_PM = to_small_caps(
        "**Hello there** {0}**!**\n\n"
    ...
    PERFORMER = to_small_caps("[ ᴛʜᴇ ᴘʙxʙᴏᴛ ]")
